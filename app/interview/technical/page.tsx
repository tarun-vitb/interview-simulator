...
export default function TechnicalInterviewPage() {
  ...
  const startInterview = useCallback(async () => {
    ...
    try {
      ...
      const interviewResponse = await fetch("/api/technical-interview", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          resumeText,
      ...
      if (!result || !result.message || result.message.trim() === "") {
        ...
        const fallbackMessage = "Hello! Let's begin the technical interview. Can you tell me about your experience with the technologies listed in your resume?";
        ...
        try {
          ...
          if (!evaluation || !evaluation.scores) {
            ...
            evaluation = {
              ...
              feedback: {
                dsa: "Evaluation could not be generated. Please try again.",
                fundamentals: "Evaluation could not be generated. Please try again.",
                problemSolving: "Evaluation could not be generated. Please try again.",
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <p className="text-sm text-gray-700 font-medium">7 questions • Maximum duration: 3 minutes</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-lg h-[calc(100vh-200px)] flex flex-col">
          ...
          {isComplete ? (
            <div className="border-t p-4 text-center">
              ...
              <button
                onClick={() => router.push("/feedback/technical")}
